...
SECRET_KEY = '8h1u%2flpqw7ajadzzg!xjs_v^a5dlo5nlab7^lc4cgk#k+@a4'
...
INSTALLED_APPS = [
    ...
    'crispy_forms',
    'social_django' #For Social Authentication. Install social-auth-app-django module first
]
...
MIDDLEWARE = [
    ...
    'social_django.middleware.SocialAuthExceptionMiddleware', #For SocialAuthentication
